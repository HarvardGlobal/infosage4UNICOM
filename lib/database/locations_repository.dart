...
class LocationsRepository {
  ...
  static Location? getDeviceLocation() {
  ...
  static Future<void> init() async {
    ...
    _deviceLocation =
        await getByLangCode(LocaleUtils.deviceLocale().toString());
  }

  static Future<void> fetchLocations() async {
    _availableLocations = [];
    _availableLocations
        .add(Location(id: 0, name: "English", langCode: "en_EN"));
    _availableLocations
        .add(Location(id: 1, name: "Italiano", langCode: "it_IT"));
  }
